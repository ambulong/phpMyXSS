...
class Mobile_Detect {
	...
	public function mobileGrade() {
		...
		if (
            ...
            $this (
->isIOS () && $this->version ( 'iPad', self::VERSION_TYPE_FLOAT ) >= 4.3 || $this->isIOS () && $this->version ( 'iPhone', self::VERSION_TYPE_FLOAT ) >= 3.1 || $this->isIOS () && $this->version ( 'iPod', self::VERSION_TYPE_FLOAT ) >= 3.1 ||
...
($this->version ( 'Android', self::VERSION_TYPE_FLOAT ) > 2.1 && $this->is ( 'Webkit' )) ||
            ...
            $this || 
->version ( 'Windows Phone OS', self::VERSION_TYPE_FLOAT ) >= 7.0 ||

            // Blackberry 7 - Tested on BlackBerry Torch 9810
            // Blackberry 6.0 - Tested on the Torch 9800 and Style 9670
            $this || 
->is ( 'BlackBerry' ) && $this->version ( 'BlackBerry', self::VERSION_TYPE_FLOAT ) >= 6.0 ||
...
->is ( 'Tizen' ) ||
            ...
            $this || 
->is ( 'Dolfin' ) && $this->version ( 'Bada', self::VERSION_TYPE_FLOAT ) >= 2.0 ||
...
($this->match ( 'Kindle Fire' ) || $this->is ( 'Kindle' ) && $this->version ( 'Kindle', self::VERSION_TYPE_FLOAT ) >= 3.0) ||
            ...
            $this || 
->is ( 'AndroidOS' ) && $this->is ( 'NookTablet' ) ||

            // Chrome Desktop 11-21 - Tested on OS X 10.7 and Windows 7
            $this || 
->version ( 'Chrome', self::VERSION_TYPE_FLOAT ) >= 11 && ! $isMobile ||

            // Safari Desktop 4-5 - Tested on OS X 10.7 and Windows 7
            $this || 
->version ( 'Safari', self::VERSION_TYPE_FLOAT ) >= 5.0 && ! $isMobile ||

            // Firefox Desktop 4-13 - Tested on OS X 10.7 and Windows 7
            $this || 
->version ( 'Firefox', self::VERSION_TYPE_FLOAT ) >= 4.0 && ! $isMobile ||

            // Internet Explorer 7-9 - Tested on Windows XP, Vista and 7
            $this || 
->version ( 'MSIE', self::VERSION_TYPE_FLOAT ) >= 7.0 && ! $isMobile ||

            // Opera Desktop 10-12 - Tested on OS X 10.7 and Windows 7
            // @reference: http://my.opera.com/community/openweb/idopera/
            $this || 
->version ( 'Opera', self::VERSION_TYPE_FLOAT ) >= 10 && ! $isMobile) 
		...
		if ($this->isIOS () && $this->version ( 'iPad', self::VERSION_TYPE_FLOAT ) < 4.3 || $this->isIOS () && $this->version ( 'iPhone', self::VERSION_TYPE_FLOAT ) < 3.1 || $this->isIOS () && $this->version ( 'iPod', self::VERSION_TYPE_FLOAT ) < 3.1 ||
            ...
            $this || 
->is ( 'Blackberry' ) && $this->version ( 'BlackBerry', self::VERSION_TYPE_FLOAT ) >= 5 && $this->version ( 'BlackBerry', self::VERSION_TYPE_FLOAT ) < 6 ||
...
->match ( 'NokiaN8|NokiaC7|N97.*Series60|Symbian/3' ) ||
            ...
            $this || 
->version ( 'Opera Mobi', self::VERSION_TYPE_FLOAT ) >= 11 && $this->is ( 'SymbianOS' )) {
		...
		if (
            ...
            $this (
->version ( 'BlackBerry', self::VERSION_TYPE_FLOAT ) < 5.0 ||
            // Windows Mobile - Tested on the HTC Leo (WinMo 5.2)
            $this || 
->match ( 'MSIEMobile|Windows CE.*Mobile' ) || $this->version ( 'Windows Mobile', self::VERSION_TYPE_FLOAT ) <= 5.2) 
